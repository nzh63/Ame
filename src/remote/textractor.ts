...
export const getTextractorPostProcessOption = defineRemoteFunction('get-textractor-post-process-option', requireContext, (event) => {
...
export const setTextractorPostProcessOption = defineRemoteFunction('set-textractor-post-process-option', requireContext, (event, option: PostProcessOption) => {
    const window = electron.BrowserWindow.fromWebContents(event.sender) as WindowWithContext;
