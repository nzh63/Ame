...
export type DictProviderConfig<ID extends string, S extends Schema, D, M extends Methods> = BaseProviderOptions<ID, S, D> & DictProviderMethods<ID, S, D, M> & { providersStoreKey: 'dictProviders' };
