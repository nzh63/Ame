...
export const availableTranslateConfigs = [...(import.meta.env.DEV ? [echo] : []), openai, hunyuan, tencentcloud, baiduAi, qqfanyi, youdaofanyi, baidufanyi, googleTranslate, JBeijing, DrEye] as const;
