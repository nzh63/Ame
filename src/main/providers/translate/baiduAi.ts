...
export default defineTranslateProvider(
  {
    id: '百度AI开放平台',
    description:
      '百度AI开放平台机器翻译API，详见 https://api.fanyi.baidu.com \n此翻译器会向 api.fanyi.baidu.com 发送数据',
    optionsSchema: {
      enable: Boolean,
      apiConfig: {
    ...
    optionsDescription: {
      ...
      apiConfig: {
        appid: {
          readableName: 'APP ID',
          description: '可在 https://api.fanyi.baidu.com/api/trans/product/desktop?req=developer 获取',
        },
        key: {
          readableName: 'Key',
          description: '可在 https://api.fanyi.baidu.com/api/trans/product/desktop?req=developer 获取',
  ...
  },
  {
    init() {},
    isReady() {
      return this.enable && this.apiConfig.appid !== null && this.apiConfig.key !== null;
    },
